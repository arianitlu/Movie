...
public class FragmentTopRated extends Fragment implements MovieAdapter.MovieAdapterOnClickHandler {

    private MovieAdapter movieAdapter;
    private MainViewModel mainViewModel;
    public List<Movie> movies1;
    public String movieCategoryChange = "top_rated";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.getMoviesWithPage("top_rated",pages).observe(this, new Observer<List<Movie>>() {
            @Override
    ...
    /**
     *
     * @param movies list of movies that is taken from API
     */
    ...
    /**
     *
     * @return return a value that tell us whether this movie is favorited or not
     */
