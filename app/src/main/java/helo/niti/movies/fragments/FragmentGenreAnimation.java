...
public class FragmentGenreAnimation extends Fragment implements MovieAdapter.MovieAdapterOnClickHandler {

    private MovieAdapter movieAdapter;
    private MainViewModel mainViewModel;
    public List<Movie> movies1;
    public String movieCategoryChange = "16";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.getMoviesWithGenresPage("16",pages).observe(this, new Observer<List<Movie>>() {
            @Override
