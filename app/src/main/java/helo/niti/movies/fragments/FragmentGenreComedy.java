...
public class FragmentGenreComedy extends Fragment implements MovieAdapter.MovieAdapterOnClickHandler {

    private MovieAdapter movieAdapter;
    private MainViewModel mainViewModel;
    public String movieCategoryChange = "";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.getMoviesWithGenresPage("35",pages).observe(this, new Observer<List<Movie>>() {
            @Override
