...
public class FragmentPopular extends Fragment implements MovieAdapter.MovieAdapterOnClickHandler {

    private MovieAdapter movieAdapter;
    private MainViewModel mainViewModel;
    public List<Movie> movies1;
    public String movieCategoryChange = "popular";
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mainViewModel.getMoviesWithPage("popular",pages).observe(this, new Observer<List<Movie>>() {
            @Override
